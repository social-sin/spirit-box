    ...
    while should_run():
        ...
        if debug:
            ...
            if result is not None:
                cv2.putText(frame_main, "{}".format(result["name"]), (5, 10), cv2.FONT_HERSHEY_TRIPLEX, 0.4, (0, 0, 0))
                cv2.putText(frame_main, "Certainty: {}%".format(result["conf"]), (5, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 0, 0))
                
            cv2.imshow("rgb", cv2.resize(frame_main, (450, 450)))
